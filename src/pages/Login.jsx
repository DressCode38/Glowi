...
function Login() {
  ...
  return (
    <div style={{ fontFamily: 'Inter, sans-serif', minHeight: '100vh', background: '#faf8f5', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
      ...
      <div style={{ width: '100%', maxWidth: '400px', background: '#fff', borderRadius: '20px', padding: '40px 32px', boxShadow: '0 8px 40px rgba(196,130,154,0.1)' }}>

        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          <h1 onClick={() => navigate('/')} style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '36px', fontWeight: '300', cursor: 'pointer', marginBottom: '8px' }}>
          ...
          <h2 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '28px', fontWeight: '300', color: '#2c2c2c' }}>Connexion</h2>
        </div>
        ...
        <form onSubmit={handleLogin}>
          ...
          <div style={{ marginBottom: '28px' }}>
            ...
            <p style={{ fontSize: '12px', color: '#c4829a', marginTop: '8px', textAlign: 'right', cursor: 'pointer' }}>Mot de passe oublié ?</p>
          </div>
        ...
        <div style={{ marginTop: '32px', paddingTop: '20px', borderTop: '1px solid #ede8e3', textAlign: 'center' }}>
