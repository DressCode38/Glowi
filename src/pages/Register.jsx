  ...
  return (
    <div style={{ fontFamily: 'Inter, sans-serif', minHeight: '100vh', background: '#faf8f5', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
      ...
      <div style={{ width: '100%', maxWidth: '420px' }}>
        ...
        <div style={{ background: '#fff', borderRadius: '20px', padding: '36px 28px', boxShadow: '0 8px 40px rgba(196,130,154,0.1)' }}>

          <div style={{ textAlign: 'center', marginBottom: '24px' }}>
            <h1 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '32px', fontWeight: '300', cursor: 'pointer', marginBottom: '6px' }} onClick={() => navigate('/')}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '24px' }}>
                  {[
                    ...
                    <div key={p.id} className={`plan-card ${plan === p.id ? 'active' : ''}`} onClick={() => setPlan(p.id)} style={{ position: 'relative' }}>
                      {p.recommande && (
                        <div style={{ position: 'absolute', top: '-10px', left: '50%', transform: 'translateX(-50%)', background: '#c4829a', color: '#fff', fontSize: '10px', letterSpacing: '1.5px', padding: '3px 14px', borderRadius: '20px', textTransform: 'uppercase', whiteSpace: 'nowrap' }}>
                          Recommandé
                        </div>
                      )}
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <p style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '22px', fontWeight: '300', color: plan === p.id ? '#c4829a' : '#2c2c2c', margin: 0 }}>
                          {p.prix}<span style={{ fontSize: '11px', color: '#c4b5ac' }}>/mois</span>
                        </p>
                      </div>
                    </div>
                  ))}
